...
obs{1}.perturbation.dx = [0; 0.2; 0]; % for moving obstacle: the obstacle's velocity
obs{1}.perturbation.t0 = 0; % for moving obstacle: the obstacle's start time
obs{1}.perturbation.tf = 5; % for moving obstacle: the obstacle's ending time
n_theta = 20; % for 3D, the number of points in x-y plane
n_phi = 15; %for 3D, the number of point in semi-half of the y-z plane
